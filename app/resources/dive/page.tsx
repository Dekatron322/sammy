      ...
      <div className="paddings xl:mt-32">
        <div className="flex w-full justify-center gap-10">
          ...
          <div className="w-full">
            ...
            <h2 className="mb-5 w-[476px] text-3xl">Dive into the Data: Key Trends Shaping Humanitarian Aid</h2>
            ...
            {isDarkMode ? (
              <img src="/resources/Frame-1618874306-_3_.webp" alt="" />
            ) : (
              <img src="/resources/Frame-1618874306.webp" alt="" />
            )}
            ...
            <div className="content-section mt-10">
              ...
              <img className="my-5" src="/resources/xioej9zewcduhucnvfmp.webp" />
            </div>
            <div className="content-section">
              <h4 className="text-2xl">How CHATS is Revolutionizing Aid Distribution for Greater Impact</h4>
              <p className="paragraph">
