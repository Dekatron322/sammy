          ...
          >
            ...
            >
              <motion.p className="mt-2 text-lg text-[#10172099] md:text-center" variants={fadeInVariants}>
                From exclusive vineyard tours to bespoke gifting and concierge services, I make fine wines and spirits a
                seamless part of your celebrations, travels, and personal moments
              </motion.p>
              ...
              >
                <motion.img src="/fresh-images/star.svg" variants={fadeInVariants} />
                <motion.p className="font-bold text-white" variants={fadeInVariants}>
                  10+ countries covered in travel plans
                </motion.p>
                <motion.img src="/fresh-images/star.svg" variants={fadeInVariants} />
              </motion.div>
