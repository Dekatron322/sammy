        ...
        <motion.div className="relative mt-10" variants={containerVariants}>
          ...
          >
            ...
            <motion.div
              ...
              variants={scaleUp}
            >
              <motion.p className="mt-2 text-lg text-[#101720CC] md:text-center 2xl:px-10" variants={fadeInVariants}>
                <b>Rare & Collectible Bottle Sourcing:</b> Accessing rare vintages, limited editions, or exclusive
                releases through private networks, auctions, or producers. Custom Bottle Selection: Curating lists for
                special events, gifts, or portfolio diversification.
              </motion.p>
