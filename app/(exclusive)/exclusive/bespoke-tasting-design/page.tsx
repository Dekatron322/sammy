      ...
      >
        ...
        <motion.div className="relative mt-10" variants={containerVariants}>
          <motion.div className="relative w-full flex-shrink-0" variants={scaleUp}>
            <motion.img
              src="/fresh-images/bespoke.png"
              alt="Bespoke Tasting Design"
          ...
          >
            ...
            >
              <motion.p className="mt-2 text-lg text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Hand-picked premium wines or rare spirits tailored to the client&apos;s taste, occasion, or theme (e.g.,
                “Iconic Bordeaux Vintages,” “The Rare Malts of Islay,” “Champagne Houses Vertical”).
              </motion.p>
              <motion.p className="mt-2 text-lg font-bold text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Thematic Concepts:
              </motion.p>
              <motion.p className="mt-2 text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
              ...
              <motion.p className=" text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Horizontal (same vintage, different regions)
              </motion.p>
              <motion.p className=" text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Regional or varietal explorations
              </motion.p>
              <motion.p className=" text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Distillery or house showcases
              </motion.p>
              <motion.p className=" text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Food-pairing focus (caviar, charcuterie, fine cheeses, chocolate, cigars){" "}
              </motion.p>
