      ...
      >
        ...
        <motion.div className="relative mt-10" variants={containerVariants}>
          <motion.div className="relative w-full flex-shrink-0" variants={scaleUp}>
            <motion.img
              src="/fresh-images/virtual.png"
              alt="Virtual & Hybrid Tasting"
          ...
          >
            ...
            >
              <motion.p className="mt-2 text-lg text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Pre-portioned samples of rare wines/spirits shipped with crystal glassware and tasting guides.
              </motion.p>
              ...
              <motion.p className="text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Exclusive live sessions for international clients or corporate groups, maintaining premium experience
                remotely.
              </motion.p>
              <motion.p className="text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                👤 Ideal Clients
              ...
              <motion.p className="text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Corporate VIP client events
              </motion.p>
              <motion.p className="text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Collector clubs or private member networks
              </motion.p>
              <motion.p className="text-lg  text-[#101720CC] md:text-center " variants={fadeInVariants}>
                Fine dining restaurants and sommeliers-in-residence programs
              </motion.p>
